...
const Intro = () => {
  return (
    <section className="flex min-h-screen flex-col items-center justify-center py-2 bg-[url('/assets/images/intro-image.jpg')] bg-cover bg-center">
      <h1 className="text-center text-3xl md:text-6xl lg:text-8xl font-bold text-sky-50 tracking-tighter leading-tight drop-shadow-md px-8">
        SMP-SMA Ali Maksum
      </h1>
      <h4 className="text-center text-sm md:text-lg lg:text-xl text-slate-50 bg-blend-difference tracking-tighter leading-tight drop-shadow-sm px-8">
